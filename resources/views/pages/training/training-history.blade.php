...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button id="importTrainingHistory" class="btn btn-primary shadow-md mr-2">Import Training Data</button>
        </div>
    </div>
    ...
    <div class="intro-y box p-5 mt-5">
            ...
            <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
                <div class="sm:flex items-center sm:mr-4">
                    ...
                    <select id="tabulator-html-filter-field"
                        ...
                        <option value="course_desc">Course Desc</option>
                    </select>
                </div>
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="tabulator-training-history" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
    <!-- END: HTML Table Data -->
@endsection
...
@section('script')
    <script type="module">
            $('#importTrainingHistory').on('click', function() {
                var url = '{{ route("training-history.import") }}';
